...
namespace ApiAll.Migrations
{
    ...
    [Migration("20220106143628_initial53464dasdasd")]
    partial class initial53464dasdasd
    {
            ...
            modelBuilder.Entity("ApiAll.Model.pos.PosCheck", b =>
                {
                    ...
                    b.HasOne("ApiAll.Model.pos.PosClient", "posClient")
                        .WithMany()
                        .HasForeignKey("PosClientid");

                    b.Navigation("auth");

                    b.Navigation("posClient");
                });
