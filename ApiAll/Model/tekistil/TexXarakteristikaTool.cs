...
namespace ApiAll.Model.tekistil
{
    ...
    public class TexXarakteristikaTool:TekstilBaseModel
    {

        public String name { get; set; }
        public String print_name { get; set; }
        public long? xarakteristika_id { get; set; }


        [System.Text.Json.Serialization.JsonIgnore]
        [Newtonsoft.Json.JsonIgnore]
        [ForeignKey("xarakteristika_id")]
        ...
        [NotMapped]
        public String xarakteristika_name => xarakteristika != null ? xarakteristika.name : "";
